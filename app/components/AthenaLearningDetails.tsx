...
export const serviceDemoAssets: Record<string, { image: string; alt: string }> = {
  "Amazon Managed Streaming for Apache Kafka (Amazon MSK)": { image: "https://raw.githubusercontent.com/kalif7722/aws-library/main/public/assets/demos/amazon-msk.webp", alt: "Amazon MSK practical Kafka workflow" },
  "Amazon QuickSight": { image: "https://raw.githubusercontent.com/kalif7722/aws-library/main/public/assets/demos/amazon-quicksight.webp", alt: "Amazon QuickSight practical dashboard workflow" },
  "Amazon AppFlow": { image: "https://raw.githubusercontent.com/kalif7722/aws-library/main/public/assets/demos/amazon-appflow.webp", alt: "Amazon AppFlow practical integration workflow" },
  "AWS AppSync": { image: "https://raw.githubusercontent.com/kalif7722/aws-library/main/public/assets/demos/aws-appsync.webp", alt: "AWS AppSync practical GraphQL workflow" },
  "Amazon EventBridge": { image: "https://raw.githubusercontent.com/kalif7722/aws-library/main/public/assets/demos/amazon-eventbridge.webp", alt: "Amazon EventBridge practical event-routing workflow" },
  "AWS Data Exchange": { image: "https://raw.githubusercontent.com/kalif7722/aws-library/main/public/assets/demos/aws-data-exchange.webp", alt: "AWS Data Exchange practical dataset subscription workflow" },
  "Amazon Data Firehose": { image: "https://raw.githubusercontent.com/kalif7722/aws-library/main/public/assets/demos/amazon-data-firehose.webp", alt: "Amazon Data Firehose practical streaming delivery workflow" },
  "Amazon Kinesis Data Streams": { image: "https://raw.githubusercontent.com/kalif7722/aws-library/main/public/assets/demos/amazon-kinesis-data-streams.webp", alt: "Amazon Kinesis Data Streams practical real-time streaming workflow" },
  "AWS Lake Formation": { image: "https://raw.githubusercontent.com/kalif7722/aws-library/main/public/assets/demos/aws-lake-formation.webp", alt: "AWS Lake Formation practical governed data lake workflow" },
  "Amazon Managed Service for Apache Flink": { image: "https://raw.githubusercontent.com/kalif7722/aws-library/main/public/assets/demos/amazon-managed-service-for-apache-flink.webp", alt: "Amazon Managed Service for Apache Flink practical streaming analytics workflow" },
