...
const objectiveAssetAliases: Record<string, string> = {
  "Describe Microsoft Entra Conditional Access": "describe-microsoft-entra-conditional-access",
  "Describe Microsoft Entra roles and role-based access control (RBAC)": "describe-entra-roles-and-rbac",
  "Describe access reviews": "describe-access-reviews",
  "Describe the capabilities of Microsoft Entra Privileged Identity Management": "describe-entra-privileged-identity-management",
  "Describe Microsoft Entra ID Protection": "describe-entra-id-protection",
  "Describe Azure Key Vault": "describe-azure-key-vault",
  "Describe Microsoft Defender for Cloud": "describe-microsoft-defender-for-cloud",
  "Describe capabilities of Microsoft Sentinel": "describe-microsoft-sentinel",
  "Describe the Microsoft Defender portal": "describe-microsoft-defender-portal",
  "Describe the Microsoft Purview portal": "describe-microsoft-purview-portal",
  "Describe Compliance Manager": "describe-compliance-manager",
  "Describe sensitivity labels and sensitivity label policies": "describe-sensitivity-labels-and-policies",
  "Describe data loss prevention (DLP)": "describe-data-loss-prevention",
  "Describe eDiscovery solutions in Microsoft Purview": "describe-ediscovery-in-microsoft-purview",
  "Describe audit solutions in Microsoft Purview": "describe-audit-solutions-in-microsoft-purview",
