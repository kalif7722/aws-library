...
export const services = [
  ...
  { name: "AWS Application Discovery Service", file: "/el10/migration/application-discovery-service.webp", accent: "#16a34a", summary: "Discover workloads for migration planning" },
  ...
  { name: "Amazon WorkSpaces Secure Browser", file: "/el10/other-services/workspaces-secure-browser.webp", accent: "#2563eb", summary: "Secure browser access to internal websites" },
  ...
  { name: "AWS Cost and Usage Reports", file: "/el10/backlog/cost-usage-reports.webp", accent: "#16a34a", summary: "Detailed cost and usage data delivered to Amazon S3" },
  { name: "Amazon EC2 Image Builder", file: "/el10/backlog/ec2-image-builder.webp", accent: "#f59e0b", summary: "Automate secure VM and container image pipelines" },
  ...
  { name: "AWS Cost and Usage Reports", file: "/el10/aws-cost-and-usage-reports.webp", accent: "#16a34a", summary: "Detailed AWS billing and usage data for analysis" },
  { name: "Amazon EC2 Image Builder", file: "/el10/amazon-ec2-image-builder.webp", accent: "#f59e0b", summary: "Automate secure image creation and distribution pipelines" },
  ...
  { name: "Amazon WorkSpaces Secure Browser", file: "/el10/amazon-workspaces-secure-browser.webp", accent: "#f59e0b", summary: "Secure browser-based access to web applications" },
  ...
  { name: "AWS Application Discovery Service", file: "/el10/aws-application-discovery-service.webp", accent: "#14b8a6", summary: "Discover on-premises inventory and application dependencies" },
];

const branches = [
  { title: "Management & Governance", start: 0, end: 34, accent: "#f05aa6", copies: [215, 216, 244, 248, 250, 256, 266, 273, 274, 275, 276] },
  { title: "Cloud Financial Management", start: 0, end: 0, accent: "#16a34a", copies: [23, 24, 25, 9, 13, 215, 216, 244, 251, 268] },
  { title: "Security, Identity & Compliance", start: 34, end: 51, accent: "#60a5fa", copies: [2, 3, 15, 22, 219, 220, 221, 222, 223, 224, 246] },
  { title: "Compute & Containers", start: 51, end: 68, accent: "#f59e0b", copies: [217, 218, 265, 269] },
  ...
  { title: "Migration & Transfer", start: 96, end: 100, accent: "#14b8a6", copies: [95, 81, 83, 82, 247, 260, 261, 278] },
  { title: "Networking & Content Delivery", start: 100, end: 120, accent: "#8b5cf6", copies: [49, 267] },
  { title: "Developer Tools", start: 120, end: 132, accent: "#f97316", copies: [180, 243, 245, 249, 257, 270, 271] },
  { title: "Analytics", start: 132, end: 151, accent: "#ec4899", copies: [161, 262, 272] },
