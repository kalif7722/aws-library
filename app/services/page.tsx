...
const branches = [
  ...
  { title: "Databases", start: 84, end: 96, accent: "#8b5cf6", copies: [264, 275, 276, 277] },
  ...
  { title: "Developer Tools", start: 120, end: 132, accent: "#f97316", copies: [180, 243, 245, 249, 257, 268, 269, 278, 279] },
