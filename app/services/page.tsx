...
export const services = [
  ...
  { name: "AWS Application Discovery Service", file: "/el10/migration-transfer/aws-application-discovery-service.webp", accent: "#16a34a", summary: "Discover workloads for migration planning" },
  ...
  { name: "Amazon WorkSpaces Secure Browser", file: "/el10/compute-containers/amazon-workspaces-secure-browser.webp", accent: "#2563eb", summary: "Secure browser access to internal websites" },
  ...
  { name: "Amazon EC2 Image Builder", file: "/el10/management-governance/amazon-ec2-image-builder.webp", accent: "#f59e0b", summary: "Automate secure VM and container image pipelines" },
  ...
  { name: "AWS Application Migration Service", file: "/el10/migration-transfer/aws-application-migration-service.webp", accent: "#14b8a6", summary: "Automated lift-and-shift server migration to AWS" },
  { name: "AWS Snow Family", file: "/el10/migration-transfer/aws-snow-family.webp", accent: "#14b8a6", summary: "Physical devices for offline data transfer and edge computing" },
  ...
  { name: "Amazon AppStream 2.0", file: "/el10/compute-containers/amazon-appstream-2.webp", accent: "#f59e0b", summary: "Stream desktop applications securely to browsers" },
  { name: "AWS Chatbot", file: "/el10/management-governance/aws-chatbot.webp", accent: "#ec4899", summary: "AWS notifications and CLI actions in chat applications" },
  { name: "Amazon Application Recovery Controller", file: "/el10/networking-content-delivery/amazon-application-recovery-controller.webp", accent: "#8b5cf6", summary: "Controlled recovery and traffic shifting for resilient applications" },
  ...
  { name: "AWS Marketplace", file: "/el10/management-governance/aws-marketplace.webp", accent: "#2563eb", summary: "Discover, procure, and govern third-party cloud products" },
  { name: "AWS Support", file: "/el10/management-governance/aws-support.webp", accent: "#2563eb", summary: "Technical support plans and AWS operational guidance" },
  { name: "AWS Health", file: "/el10/management-governance/aws-health.webp", accent: "#2563eb", summary: "Personalized AWS service health and account events" },
  { name: "AWS Resilience Hub", file: "/el10/management-governance/aws-resilience-hub.webp", accent: "#2563eb", summary: "Assess and improve application resiliency" },
];
