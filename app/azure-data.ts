...
const azureFilenameOverrides: Record<string, string> = {
  ...
  "microsoft-fabric": "microsoft-fabric.webp",
  "microsoft-foundry": "microsoft-foundry.webp",
  "microsoft-purview": "microsoft-purview.webp",
  "microsoft-graph-data-connect": "microsoft-graph-data-connect.webp",
  ...
  "nutanix-cloud-clusters": "nutanix-cloud-clusters.webp",
  ...
  "static-web-apps": "static-web-apps.webp",
  "virtual-machines": "virtual-machines.webp",
  "virtual-machine-scale-sets": "virtual-machine-scale-sets.webp",
  ...
  "azure-kubernetes-service": "azure-kubernetes-service.webp",
...
export const azureUniqueServices = (() => {
  ...
  for (const branch of azureBranches) {
    for (const service of branch.services) {
      if (!unique.has(service.slug)) unique.set(service.slug, service);
    }
  }
